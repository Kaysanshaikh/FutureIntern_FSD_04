...
import { toastOptions } from "C:/Users/Admin/Desktop/FutureIntern/Talkify by Kaysan Shaikh/public/src/utils/constants";
      ...
      <div className="resiter-wrapper form-container">
        <form className="form signup" onSubmit={(event) => handleSubmit(event)}>
          ...
          <div className="login-signup">
            <span className="text">
              Already have an account ? <button onClick={() => isLoginActive('yes')} className="login-link">Login</button>
            </span>
          </div>
        </form>
      </div>
